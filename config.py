...
CLICK_DELAY = 0.008
MOUSE_MOVE_DELAY = 0.0015
MOUSE_DOWN_UP_DELAY = 0.0012
DOUBLE_CLICK_DELAY = 0.009

MOUSE_MOVE_RETRIES = 2
MOUSE_MOVE_RETRY_DELAY = 0.002
MOUSE_TARGET_SETTLE_DELAY = 0.002
MOUSE_TARGET_TIMEOUT = 0.025
...
SCROLL_INTERVAL_PAUSE = 0.007
POST_SCROLL_SETTLE = 0.040
CYCLE_PAUSE_DURATION = 0.014
SCROLL_DURATION = 0.13
SCROLL_STEP_COUNT = 28
SCROLL_MIN_INTERVAL = 0.005
OSCILLATION_CYCLE_COOLDOWN = 0.018
SCROLL_SETTLE_DELAY = 0.007

MAIN_LOOP_DELAY = 0.002
STATE_DELAY = 0.007
STATE_MIN_INTERVAL_DEFAULT = 0.014
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.070,
    "OPEN_BOXES": 0.040,
    "SCROLL": 0.045,
    "SEARCH_UPGRADE_STATION": 0.072,
    "CLICK_RED_ICON": 0.032,
    "HOLD_UPGRADE_STATION": 0.040,
    "CHECK_UNLOCK": 0.028,
    "CHECK_NEW_LEVEL": 0.040,
    "UPGRADE_STATS": 0.036,
    "TRANSITION_LEVEL": 0.040,
    "WAIT_FOR_UNLOCK": 0.018,
}
...
UPGRADE_HOLD_DURATION = 1.00
UPGRADE_CLICK_INTERVAL = 0.0014

SPAM_CLICK_DURATION = 3.5
SPAM_CLICK_DELAY = 0.007
SPAM_CLICK_JITTER = 0
RAPID_CLICK_DOWN_UP_DELAY = 0.0025
RAPID_CLICK_SPIN_THRESHOLD = 0.0010

UPGRADE_SEARCH_INTERVAL = 0.060

STATS_UPGRADE_CLICK_DURATION = 0.149
STATS_UPGRADE_CLICK_DELAY = 0.006
STATS_ICON_PADDING = 20

IDLE_CLICK_SETTLE_DELAY = 0.008
IDLE_CLICK_COOLDOWN = 0.018
...
RED_ICON_STABILITY_CACHE_TTL = 0.149
...
FORBIDDEN_ZONE_SCROLL_REENTRY_COOLDOWN = 0.110
FORBIDDEN_BLACKOUT_DURATION = 0.149

FORBIDDEN_ZONE_PRECLICK_VALIDATION_DELAY = 0.003
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.0045
ASSET_BOUNDARY_PRECHECK_DELAY = 0.004
ASSET_BOUNDARY_CONFIRM_DELAY = 0.005
ASSET_SEGREGATION_DELAY = 0.010

LEVEL_TRANSITION_MAX_ATTEMPTS = 5
LEVEL_COMPLETION_RECENCY_WINDOW = 0.149
NEW_LEVEL_FAIL_COOLDOWN = 0.149

NEW_LEVEL_BUTTON_DELAY = 0.032
NEW_LEVEL_FOLLOWUP_DELAY = 0.149
TRANSITION_POST_CLICK_DELAY = 0.149
TRANSITION_RETRY_DELAY = 0.060

NEW_LEVEL_INTERRUPT_INTERVAL = 0.010
NEW_LEVEL_MONITOR_INTERVAL = 0.018
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.045
...
ADAPTIVE_TUNER_MOVE_DELAY_STEP = 0.0008
...
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.026
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.0015
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.0075
ADAPTIVE_TUNER_MIN_UPGRADE_INTERVAL = 0.014
ADAPTIVE_TUNER_MAX_UPGRADE_INTERVAL = 0.014
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.040
...
AI_VISION_SAVE_INTERVAL = 0.149

AI_LEARNING_ENABLED = True
AI_LEARNING_STATE_FILE = str(BASE_DIR / "memory" / "learning_state.json")
AI_LEARNING_SAVE_INTERVAL = 0.149
AI_LEARNING_RECORDS_LIMIT = 256
AI_LEARNING_THREAD_JOIN_TIMEOUT = 0.149
AI_LEARNING_THREAD_INTERVAL = 0.149
...
AI_LEARNING_APPLY_COOLDOWN = 0.149

AI_LEARNING_MIN_CLICK_DELAY = 0.008
AI_LEARNING_MAX_CLICK_DELAY = 0.024
AI_LEARNING_MIN_MOVE_DELAY = 0.0015
AI_LEARNING_MAX_MOVE_DELAY = 0.0065
AI_LEARNING_MIN_UPGRADE_INTERVAL = 0.014
AI_LEARNING_MAX_UPGRADE_INTERVAL = 0.014
