...
MOUSE_DOWN_DURATION = 0.200
MOUSE_UP_DURATION = 0.200
HOVER_ENABLED = True
HOVER_DURATION = 0.075
UPGRADE_SEARCH_INTERVAL = 0.145
STATE_DELAY = 0.155
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.280
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 5
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.145
CLICK_HOLD_MAX_DURATION = 11.0
...
STATS_UPGRADE_CLICK_DURATION = 2.70
STATS_UPGRADE_CLICK_DELAY = 0.022
...
SPAM_CLICK_DURATION = 1.35
SPAM_CLICK_DELAY = 0.048
SPAM_CLICK_JITTER = 0
...
ADAPTIVE_TUNER_MOVE_DELAY_STEP = 0.0020
ADAPTIVE_TUNER_CLICK_DECREMENT = 0.0030
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.0014
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.012
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.0040
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.050
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.095
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.012
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.032
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.125
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.205
...
AI_LEARNING_THREAD_JOIN_TIMEOUT = 0.7
...
AI_LEARNING_APPLY_COOLDOWN = 16.0
AI_LEARNING_MIN_CLICK_DELAY = 0.050
AI_LEARNING_MAX_CLICK_DELAY = 0.095
AI_LEARNING_MIN_MOVE_DELAY = 0.012
AI_LEARNING_MAX_MOVE_DELAY = 0.032
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.125
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.205
