...
SCROLL_INTERVAL_PAUSE = 0.048
POST_SCROLL_SETTLE = 0.160
CYCLE_PAUSE_DURATION = 0.080
SCROLL_DURATION = 0.30
SCROLL_STEP_COUNT = 20
SCROLL_MIN_INTERVAL = 0.048
OSCILLATION_CYCLE_COOLDOWN = 0.08
SCROLL_SETTLE_DELAY = 0.048

MAIN_LOOP_DELAY = 0.032
STATE_DELAY = 0.048
STATE_MIN_INTERVAL_DEFAULT = 0.048
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.128,
    "OPEN_BOXES": 0.096,
    "SCROLL": 0.112,
    "SEARCH_UPGRADE_STATION": 0.144,
    "CLICK_RED_ICON": 0.080,
    "HOLD_UPGRADE_STATION": 0.096,
    "CHECK_UNLOCK": 0.080,
    "CHECK_NEW_LEVEL": 0.096,
    "UPGRADE_STATS": 0.096,
    "TRANSITION_LEVEL": 0.112,
    "WAIT_FOR_UNLOCK": 0.064,
}
...
UPGRADE_CLICK_INTERVAL = 0.032

SPAM_CLICK_DURATION = 4.0
SPAM_CLICK_DELAY = 0.032
SPAM_CLICK_JITTER = 0
RAPID_CLICK_DOWN_UP_DELAY = 0.016
RAPID_CLICK_SPIN_THRESHOLD = 0.008

UPGRADE_SEARCH_INTERVAL = 0.144

STATS_UPGRADE_CLICK_DURATION = 2.0
STATS_UPGRADE_CLICK_DELAY = 0.032
STATS_ICON_PADDING = 20

IDLE_CLICK_SETTLE_DELAY = 0.048
IDLE_CLICK_COOLDOWN = 0.112
...
CAPTURE_CACHE_TTL = 0.048
NEW_LEVEL_RED_ICON_CACHE_TTL = 0.048
...
FORBIDDEN_ZONE_DETECTION_PRE_DELAY = 0.032
FORBIDDEN_ZONE_DETECTION_POST_DELAY = 0.032
FORBIDDEN_ZONE_DEBOUNCE_TICKS = 3
FORBIDDEN_ZONE_DEBOUNCE_REQUIRED_CONSENSUS = 2
FORBIDDEN_ZONE_SCROLL_REENTRY_COOLDOWN = 0.32
FORBIDDEN_BLACKOUT_DURATION = 4.0

FORBIDDEN_ZONE_PRECLICK_VALIDATION_DELAY = 0.016
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.016
ASSET_BOUNDARY_PRECHECK_DELAY = 0.016
ASSET_BOUNDARY_CONFIRM_DELAY = 0.016
ASSET_SEGREGATION_DELAY = 0.016

LEVEL_TRANSITION_MAX_ATTEMPTS = 5
LEVEL_COMPLETION_RECENCY_WINDOW = 5.0
NEW_LEVEL_FAIL_COOLDOWN = 8.0

NEW_LEVEL_BUTTON_DELAY = 0.160
NEW_LEVEL_FOLLOWUP_DELAY = 1.500
TRANSITION_POST_CLICK_DELAY = 1.250
TRANSITION_RETRY_DELAY = 0.320

NEW_LEVEL_INTERRUPT_INTERVAL = 0.064
NEW_LEVEL_MONITOR_INTERVAL = 0.128
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.320
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.032
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.064
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.016
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.032
ADAPTIVE_TUNER_MIN_UPGRADE_INTERVAL = 0.032
ADAPTIVE_TUNER_MAX_UPGRADE_INTERVAL = 0.048
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.128
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.192
...
AI_LEARNING_APPLY_COOLDOWN = 1.5

AI_LEARNING_MIN_CLICK_DELAY = 0.032
AI_LEARNING_MAX_CLICK_DELAY = 0.064
AI_LEARNING_MIN_MOVE_DELAY = 0.016
AI_LEARNING_MAX_MOVE_DELAY = 0.032
AI_LEARNING_MIN_UPGRADE_INTERVAL = 0.032
AI_LEARNING_MAX_UPGRADE_INTERVAL = 0.048
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.128
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.192

OVERLAY_UPDATE_INTERVAL = 0.128
LEARNING_LOOP_MIN_SLEEP = 0.032
MONITOR_YIELD_BACKOFF = 0.256
MONITOR_POLL_MIN_SLEEP = 0.032
BACKUP_CLICK_GAP = 0.128
UNLOCK_REGISTER_WAIT = 0.128
VERIFICATION_SCROLL_DURATION = 0.256
UNLOCK_HOT_LOOP_TIMEOUT = 5.0
UNLOCK_POLL_INTERVAL = 0.064
THREAD_JOIN_TIMEOUT = 1.0
HOLD_ITERATION_INTERVAL = 0.064
DRAG_MIN_DURATION = 0.016
DEFAULT_DRAG_DURATION = 0.320
