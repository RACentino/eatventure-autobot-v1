...
SUPERVISION_ENABLED = _env_flag("EATVENTURE_SUPERVISION_ENABLED", True)
SUPERVISION_BOX_NMS_ENABLED = _env_flag("EATVENTURE_SUPERVISION_BOX_NMS_ENABLED", True)
SUPERVISION_RED_ICON_NMS_ENABLED = _env_flag("EATVENTURE_SUPERVISION_RED_ICON_NMS_ENABLED", True)
SUPERVISION_UPGRADE_STATION_NMS_ENABLED = _env_flag("EATVENTURE_SUPERVISION_UPGRADE_STATION_NMS_ENABLED", True)
...
SCRCPY_MISS_RECOVERY_ENABLED = _env_flag("EATVENTURE_SCRCPY_MISS_RECOVERY_ENABLED", True)
...
POST_SCROLL_SETTLE = 0.380
SCROLL_DURATION = 0.260
