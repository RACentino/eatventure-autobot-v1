...
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.112
...
UPGRADE_HOLD_CHECK_INTERVAL_MAX = 0.112
...
UNLOCK_SEARCH_INTERVAL = 0.112

# Delay after a confirmed unlock click.
UNLOCK_SETTLE_DELAY = 0.112
