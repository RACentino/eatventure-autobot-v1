...
CLICK_DELAY = 0.016
MOUSE_MOVE_DELAY = 0.0035
MOUSE_DOWN_UP_DELAY = 0.0025
DOUBLE_CLICK_DELAY = 0.018
...
SCROLL_PIXEL_STEP = 136
SCROLL_DISTANCE_RATIO = 1
SCROLL_VERIFICATION_DISTANCE = 168
MAX_SCROLL_CYCLES = 6
SCROLL_INCREMENT_STEP = 1
SCROLL_INTERVAL_PAUSE = 0.018
POST_SCROLL_SETTLE = 0.094
CYCLE_PAUSE_DURATION = 0.040
SCROLL_DURATION = 0.27
SCROLL_STEP_COUNT = 28
SCROLL_MIN_INTERVAL = 0.012
OSCILLATION_CYCLE_COOLDOWN = 0.03
SCROLL_SETTLE_DELAY = 0.018

MAIN_LOOP_DELAY = 0.008
STATE_DELAY = 0.018
STATE_MIN_INTERVAL_DEFAULT = 0.018
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.085,
    "OPEN_BOXES": 0.050,
    "SCROLL": 0.060,
    "SEARCH_UPGRADE_STATION": 0.090,
    "CLICK_RED_ICON": 0.040,
    "HOLD_UPGRADE_STATION": 0.050,
    "CHECK_UNLOCK": 0.035,
    "CHECK_NEW_LEVEL": 0.050,
    "UPGRADE_STATS": 0.045,
    "TRANSITION_LEVEL": 0.050,
    "WAIT_FOR_UNLOCK": 0.025,
}
...
UPGRADE_CLICK_INTERVAL = 0.014

SPAM_CLICK_DURATION = 4.0
SPAM_CLICK_DELAY = 0.014
SPAM_CLICK_JITTER = 0
RAPID_CLICK_DOWN_UP_DELAY = 0.0048
RAPID_CLICK_SPIN_THRESHOLD = 0.0022

UPGRADE_SEARCH_INTERVAL = 0.090

STATS_UPGRADE_CLICK_DURATION = 2.0
STATS_UPGRADE_CLICK_DELAY = 0.013
STATS_ICON_PADDING = 20

IDLE_CLICK_SETTLE_DELAY = 0.022
...
FORBIDDEN_ZONE_DETECTION_PRE_DELAY = 0.012
FORBIDDEN_ZONE_DETECTION_POST_DELAY = 0.014
...
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.006
ASSET_BOUNDARY_PRECHECK_DELAY = 0.005
ASSET_BOUNDARY_CONFIRM_DELAY = 0.007
...
NEW_LEVEL_FOLLOWUP_DELAY = 0.80
TRANSITION_POST_CLICK_DELAY = 0.65
TRANSITION_RETRY_DELAY = 0.12

NEW_LEVEL_INTERRUPT_INTERVAL = 0.012
NEW_LEVEL_MONITOR_INTERVAL = 0.024
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.08
...
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.052
...
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.052
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.105
