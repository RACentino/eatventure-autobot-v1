...
MOUSE_DOWN_UP_DELAY = 0.010
DOUBLE_CLICK_DELAY = 0.020

MOUSE_MOVE_RETRIES = 2
MOUSE_MOVE_RETRY_DELAY = 0.006
MOUSE_TARGET_SETTLE_DELAY = 0.004
MOUSE_TARGET_TIMEOUT = 0.024
MOUSE_TARGET_CHECK_INTERVAL = 0.003
MOUSE_TARGET_HOVER_DELAY = 0.003
MOUSE_STABILIZE_DURATION = 0.003
MOUSE_TARGET_RETRIES = 2
MOUSE_TARGET_CORRECTION_DELAY = 0.003
MOUSE_POSITION_TOLERANCE = 1

MOUSE_PRE_CLICK_STABILIZE_BASE = 0.003
MOUSE_PRE_CLICK_STABILIZE_MAX = 0.012
MOUSE_PRE_CLICK_STABILIZE_DISTANCE_FACTOR = 0.000015

MOUSE_CLICK_RETRY_COUNT = 3
MOUSE_CLICK_RETRY_SETTLE_DELAY = 0.003
...
SCROLL_INTERVAL_PAUSE = 0.008
POST_SCROLL_SETTLE = 0.014
CYCLE_PAUSE_DURATION = 0.008
SCROLL_DURATION = 0.205
SCROLL_STEP_COUNT = 16
SCROLL_MIN_INTERVAL = 0.008
OSCILLATION_CYCLE_COOLDOWN = 0.008
...
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.020,
    "OPEN_BOXES": 0.016,
    "SCROLL": 0.020,
    "SEARCH_UPGRADE_STATION": 0.024,
    "CLICK_RED_ICON": 0.016,
    "HOLD_UPGRADE_STATION": 0.020,
    "CHECK_UNLOCK": 0.014,
    "CHECK_NEW_LEVEL": 0.016,
    "UPGRADE_STATS": 0.016,
    "TRANSITION_LEVEL": 0.024,
    "WAIT_FOR_UNLOCK": 0.014,
}
...
RED_ICON_STABILITY_CACHE_TTL = 0.60
...
RED_ICON_CLICK_VERIFY_DELAY = 0.018
RED_ICON_CLICK_RETRY_DELAY = 0.010
RED_ICON_CLICK_MAX_RETRIES = 2
RED_ICON_CLICK_STUCK_MAX_CYCLES = 3
RED_ICON_CLICK_RECHECK_THRESHOLD_DROP = 0.04
WAIT_FOR_UNLOCK_MAX_ATTEMPTS = 50

FORBIDDEN_ZONE_DETECTION_PRE_DELAY = 0.002
FORBIDDEN_ZONE_DETECTION_POST_DELAY = 0.002
FORBIDDEN_ZONE_DEBOUNCE_TICKS = 2
FORBIDDEN_ZONE_DEBOUNCE_REQUIRED_CONSENSUS = 2
FORBIDDEN_ZONE_SCROLL_REENTRY_COOLDOWN = 0.05
FORBIDDEN_BLACKOUT_DURATION = 1.6

FORBIDDEN_ZONE_PRECLICK_VALIDATION_DELAY = 0.001
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.001
ASSET_BOUNDARY_PRECHECK_DELAY = 0.001
ASSET_BOUNDARY_CONFIRM_DELAY = 0.001
ASSET_SEGREGATION_DELAY = 0.001

LEVEL_TRANSITION_MAX_ATTEMPTS = 5
LEVEL_COMPLETION_RECENCY_WINDOW = 5.0
NEW_LEVEL_FAIL_COOLDOWN = 3.0

NEW_LEVEL_BUTTON_DELAY = 0.024
NEW_LEVEL_FOLLOWUP_DELAY = 0.420
TRANSITION_POST_CLICK_DELAY = 0.320
TRANSITION_RETRY_DELAY = 0.080
NEW_LEVEL_POST_TRANSITION_IGNORE_WINDOW = 5.0

NEW_LEVEL_INTERRUPT_INTERVAL = 0.008
NEW_LEVEL_MONITOR_INTERVAL = 0.024
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.080
...
ADAPTIVE_TUNER_CLICK_DELAY_STEP = 0.003
ADAPTIVE_TUNER_MOVE_DELAY_STEP = 0.0015
ADAPTIVE_TUNER_CLICK_DECREMENT = 0.0015
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.0008
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.006
...
ADAPTIVE_TUNER_MAX_UPGRADE_INTERVAL = 0.028
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.024
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.072
...
AI_LEARNING_MIN_CLICK_DELAY = 0.006
...
AI_LEARNING_MAX_UPGRADE_INTERVAL = 0.028
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.024
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.072

OVERLAY_UPDATE_INTERVAL = 0.032
LEARNING_LOOP_MIN_SLEEP = 0.012
MONITOR_YIELD_BACKOFF = 0.064
MONITOR_POLL_MIN_SLEEP = 0.008
BACKUP_CLICK_GAP = 0.032
UNLOCK_REGISTER_WAIT = 0.032
VERIFICATION_SCROLL_DURATION = 0.096
UNLOCK_HOT_LOOP_TIMEOUT = 5.0
UNLOCK_POLL_INTERVAL = 0.008
THREAD_JOIN_TIMEOUT = 1.0
HOLD_ITERATION_INTERVAL = 0.016
DRAG_MIN_DURATION = 0.006
DEFAULT_DRAG_DURATION = 0.096
WINDOW_CAPTURE_RETRIES = 3
WINDOW_CAPTURE_RETRY_DELAY = 0.012
