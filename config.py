...
DOUBLE_CLICK_DELAY = 0.100

MOUSE_MOVE_RETRIES = 2
MOUSE_MOVE_RETRY_DELAY = 0.033
MOUSE_TARGET_SETTLE_DELAY = 0.050
MOUSE_TARGET_TIMEOUT = 0.150
MOUSE_TARGET_CHECK_INTERVAL = 0.016
MOUSE_TARGET_HOVER_DELAY = 0.033
...
CYCLE_PAUSE_DURATION = 0.100
SCROLL_DURATION = 0.350
SCROLL_STEP_COUNT = 32
SCROLL_MIN_INTERVAL = 0.050
OSCILLATION_CYCLE_COOLDOWN = 0.150
...
STATE_MIN_INTERVALS = {
    ...
    "OPEN_BOXES": 0.100,
    "SCROLL": 0.150,
    "SEARCH_UPGRADE_STATION": 0.100,
    "CLICK_RED_ICON": 0.100,
    "HOLD_UPGRADE_STATION": 0.100,
    "CHECK_UNLOCK": 0.100,
    "CHECK_NEW_LEVEL": 0.100,
    "UPGRADE_STATS": 0.100,
    "TRANSITION_LEVEL": 0.200,
...
CAPTURE_CACHE_TTL = 0.050
NEW_LEVEL_RED_ICON_CACHE_TTL = 0.050
...
FORBIDDEN_ZONE_PRECLICK_VALIDATION_DELAY = 0.033
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.033
ASSET_BOUNDARY_PRECHECK_DELAY = 0.033
ASSET_BOUNDARY_CONFIRM_DELAY = 0.033
...
NEW_LEVEL_BUTTON_DELAY = 0.200
NEW_LEVEL_FOLLOWUP_DELAY = 1.000
TRANSITION_POST_CLICK_DELAY = 1.000
TRANSITION_RETRY_DELAY = 0.250
NEW_LEVEL_POST_TRANSITION_IGNORE_WINDOW = 5.0

NEW_LEVEL_INTERRUPT_INTERVAL = 0.050
NEW_LEVEL_MONITOR_INTERVAL = 0.100
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.500
...
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.066
ADAPTIVE_TUNER_MIN_UPGRADE_INTERVAL = 0.033
ADAPTIVE_TUNER_MAX_UPGRADE_INTERVAL = 0.080
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.100
...
AI_LEARNING_MAX_MOVE_DELAY = 0.066
AI_LEARNING_MIN_UPGRADE_INTERVAL = 0.033
AI_LEARNING_MAX_UPGRADE_INTERVAL = 0.080
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.100
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.250

OVERLAY_UPDATE_INTERVAL = 0.100
LEARNING_LOOP_MIN_SLEEP = 0.050
MONITOR_YIELD_BACKOFF = 0.150
MONITOR_POLL_MIN_SLEEP = 0.050
BACKUP_CLICK_GAP = 0.150
UNLOCK_REGISTER_WAIT = 0.150
VERIFICATION_SCROLL_DURATION = 0.250
UNLOCK_HOT_LOOP_TIMEOUT = 5.0
UNLOCK_POLL_INTERVAL = 0.050
THREAD_JOIN_TIMEOUT = 1.0
HOLD_ITERATION_INTERVAL = 0.050
DRAG_MIN_DURATION = 0.050
DEFAULT_DRAG_DURATION = 0.250
WINDOW_CAPTURE_RETRIES = 3
WINDOW_CAPTURE_RETRY_DELAY = 0.050
