...
CLICK_DELAY = 0.080
MOUSE_MOVE_DELAY = 0.024
HOVER_ENABLED = True
HOVER_DURATION = 0.100
UPGRADE_SEARCH_INTERVAL = 0.165
STATE_DELAY = 0.180
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.620
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 5
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.240
...
STATS_UPGRADE_CLICK_DURATION = 1.90
STATS_UPGRADE_CLICK_DELAY = 0.024
...
SPAM_CLICK_DURATION = 1.70
SPAM_CLICK_DELAY = 0.060
SPAM_CLICK_JITTER = 0
RAPID_CLICK_DOWN_UP_DELAY = 0.013
...
ADAPTIVE_TUNER_MOVE_DELAY_STEP = 0.0025
ADAPTIVE_TUNER_CLICK_DECREMENT = 0.0025
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.0010
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.018
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.0050
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.075
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.135
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.022
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.045
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.160
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.260
...
AI_LEARNING_THREAD_JOIN_TIMEOUT = 0.9
AI_LEARNING_THREAD_INTERVAL = 0.85
...
AI_LEARNING_APPLY_COOLDOWN = 24.0
AI_LEARNING_MIN_CLICK_DELAY = 0.075
AI_LEARNING_MAX_CLICK_DELAY = 0.135
AI_LEARNING_MIN_MOVE_DELAY = 0.022
AI_LEARNING_MAX_MOVE_DELAY = 0.045
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.160
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.260
LEARNING_LOOP_MIN_SLEEP = 0.85
