...
SCROLL_INTERVAL_PAUSE = 0.012
POST_SCROLL_SETTLE = 0.024
CYCLE_PAUSE_DURATION = 0.012
SCROLL_DURATION = 0.128
SCROLL_STEP_COUNT = 32
SCROLL_MIN_INTERVAL = 0.012
OSCILLATION_CYCLE_COOLDOWN = 0.012
SCROLL_SETTLE_DELAY = 0.012

MAIN_LOOP_DELAY = 0.006
STATE_DELAY = 0.012
STATE_MIN_INTERVAL_DEFAULT = 0.012
STATE_MIN_INTERVALS = {
    "FIND_RED_ICONS": 0.032,
    "OPEN_BOXES": 0.024,
    "SCROLL": 0.032,
    "SEARCH_UPGRADE_STATION": 0.040,
    "CLICK_RED_ICON": 0.024,
    "HOLD_UPGRADE_STATION": 0.032,
    "CHECK_UNLOCK": 0.024,
    "CHECK_NEW_LEVEL": 0.024,
    "UPGRADE_STATS": 0.024,
    "TRANSITION_LEVEL": 0.040,
    "WAIT_FOR_UNLOCK": 0.024,
}
...
IDLE_CLICK_SETTLE_DELAY = 0.012
IDLE_CLICK_COOLDOWN = 0.024
...
RED_ICON_STABILITY_CACHE_TTL = 0.80
...
FORBIDDEN_ZONE_DETECTION_PRE_DELAY = 0.004
FORBIDDEN_ZONE_DETECTION_POST_DELAY = 0.004
FORBIDDEN_ZONE_DEBOUNCE_TICKS = 2
FORBIDDEN_ZONE_DEBOUNCE_REQUIRED_CONSENSUS = 2
FORBIDDEN_ZONE_SCROLL_REENTRY_COOLDOWN = 0.08
FORBIDDEN_BLACKOUT_DURATION = 1.6

FORBIDDEN_ZONE_PRECLICK_VALIDATION_DELAY = 0.002
FORBIDDEN_ZONE_DOUBLE_CHECK_DELAY = 0.002
ASSET_BOUNDARY_PRECHECK_DELAY = 0.002
ASSET_BOUNDARY_CONFIRM_DELAY = 0.002
ASSET_SEGREGATION_DELAY = 0.002

LEVEL_TRANSITION_MAX_ATTEMPTS = 5
LEVEL_COMPLETION_RECENCY_WINDOW = 5.0
NEW_LEVEL_FAIL_COOLDOWN = 3.0

NEW_LEVEL_BUTTON_DELAY = 0.036
NEW_LEVEL_FOLLOWUP_DELAY = 0.600
TRANSITION_POST_CLICK_DELAY = 0.480
TRANSITION_RETRY_DELAY = 0.120
NEW_LEVEL_POST_TRANSITION_IGNORE_WINDOW = 5.0

NEW_LEVEL_INTERRUPT_INTERVAL = 0.012
NEW_LEVEL_MONITOR_INTERVAL = 0.036
NEW_LEVEL_OVERRIDE_COOLDOWN = 0.120
...
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.036
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.096
...
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.036
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.096

OVERLAY_UPDATE_INTERVAL = 0.048
LEARNING_LOOP_MIN_SLEEP = 0.016
MONITOR_YIELD_BACKOFF = 0.096
MONITOR_POLL_MIN_SLEEP = 0.012
BACKUP_CLICK_GAP = 0.048
UNLOCK_REGISTER_WAIT = 0.048
VERIFICATION_SCROLL_DURATION = 0.128
UNLOCK_HOT_LOOP_TIMEOUT = 5.0
UNLOCK_POLL_INTERVAL = 0.012
THREAD_JOIN_TIMEOUT = 1.0
HOLD_ITERATION_INTERVAL = 0.024
DRAG_MIN_DURATION = 0.008
DEFAULT_DRAG_DURATION = 0.128
