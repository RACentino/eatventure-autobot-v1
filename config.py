...
CLICK_DELAY = 0.28
MOUSE_MOVE_DELAY = 0.060
HOVER_ENABLED = True
HOVER_DURATION = 0.150
UPGRADE_SEARCH_INTERVAL = 0.350
STATE_DELAY = 0.450
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 1.000
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 7
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.450
...
ADAPTIVE_TUNER_CLICK_DELAY_STEP = 0.030
ADAPTIVE_TUNER_MOVE_DELAY_STEP = 0.008
ADAPTIVE_TUNER_CLICK_DECREMENT = 0.005
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.002
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.050
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.010
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.26
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.50
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.050
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.100
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.30
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.65
...
AI_LEARNING_SAVE_INTERVAL = 15.0
...
AI_LEARNING_APPLY_COOLDOWN = 60.0
AI_LEARNING_MIN_CLICK_DELAY = 0.26
AI_LEARNING_MAX_CLICK_DELAY = 0.50
AI_LEARNING_MIN_MOVE_DELAY = 0.050
AI_LEARNING_MAX_MOVE_DELAY = 0.100
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.30
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.65
