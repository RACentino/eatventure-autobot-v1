...
MOUSE_DOWN_DURATION = 0.042
MOUSE_UP_DURATION = 0.018
HOVER_ENABLED = True
HOVER_DURATION = 0.012
UPGRADE_SEARCH_INTERVAL = 0.140
STATE_DELAY = 0.180
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.280
...
POST_SCROLL_SETTLE = 0.220
SCROLL_DURATION = 0.180

SPAM_CLICK_DURATION = 1.20
SPAM_CLICK_DELAY = 0.070
SPAM_CLICK_JITTER = 0
...
ADAPTIVE_TUNER_CLICK_DECREMENT = 0.0030
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.0008
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.020
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.0060
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.070
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.140
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.008
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.025
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.120
...
AI_VISION_SAVE_INTERVAL = 120.0

AI_LEARNING_ENABLED = False
AI_LEARNING_STATE_FILE = str(MEMORY_DIR / "learning_state_stable.json")
AI_LEARNING_SAVE_INTERVAL = 120.0
AI_LEARNING_RECORDS_LIMIT = 256
AI_LEARNING_THREAD_JOIN_TIMEOUT = 0.80
AI_LEARNING_THREAD_INTERVAL = 1.00
...
AI_LEARNING_MIN_CLICK_DELAY = 0.070
AI_LEARNING_MAX_CLICK_DELAY = 0.140
AI_LEARNING_MIN_MOVE_DELAY = 0.008
AI_LEARNING_MAX_MOVE_DELAY = 0.025
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.120
