...
CLICK_DELAY = 0.135
MOUSE_MOVE_DELAY = 0.038
HOVER_ENABLED = True
HOVER_DURATION = 0.090
UPGRADE_SEARCH_INTERVAL = 0.260
STATE_DELAY = 0.280
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 1.050
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 6
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.340
...
STATS_UPGRADE_CLICK_DURATION = 2.15
...
SPAM_CLICK_DELAY = 0.058
SPAM_CLICK_JITTER = 0
RAPID_CLICK_DOWN_UP_DELAY = 0.015
...
ADAPTIVE_TUNER_MOVE_DECREMENT = 0.0012
ADAPTIVE_TUNER_SEARCH_INTERVAL_STEP = 0.020
ADAPTIVE_TUNER_SEARCH_DECREMENT = 0.0045
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.120
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.220
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.032
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.052
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.230
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.340
...
AI_BOX_THRESHOLD_MIN = 0.900
AI_BOX_THRESHOLD_MAX = 0.900
...
AI_LEARNING_THREAD_INTERVAL = 1.25
...
AI_LEARNING_MIN_CLICK_DELAY = 0.120
AI_LEARNING_MAX_CLICK_DELAY = 0.220
AI_LEARNING_MIN_MOVE_DELAY = 0.032
AI_LEARNING_MAX_MOVE_DELAY = 0.052
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.230
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.340
