...
STATS_RED_ICON_THRESHOLD = 0.942
UPGRADE_STATION_THRESHOLD = 0.895
BOX_THRESHOLD = 0.893
...
UPGRADE_SEARCH_INTERVAL = 0.18
STATE_DELAY = 0.18
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.750
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 6
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.500
...
UPGRADE_STATION_HSV_RANGES = (
    ((6, 79, 180), (30, 203, 255)),
    ((100, 43, 182), (104, 191, 255)),
)
UPGRADE_STATION_HSV_MIN_MATCH_RATIO = 0.45
...
SPAM_CLICK_DURATION = 3.0
SPAM_CLICK_DELAY = 0.034
SPAM_CLICK_JITTER = 0
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.10
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.26
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.006
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.030
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.12
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.32
...
AI_BOX_THRESHOLD_MIN = 0.893
AI_BOX_THRESHOLD_MAX = 0.893
...
AI_UPGRADE_STATION_THRESHOLD_MIN = 0.895
AI_UPGRADE_STATION_THRESHOLD_MAX = 0.895
...
AI_LEARNING_MIN_CLICK_DELAY = 0.10
AI_LEARNING_MAX_CLICK_DELAY = 0.26
AI_LEARNING_MIN_MOVE_DELAY = 0.006
AI_LEARNING_MAX_MOVE_DELAY = 0.030
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.12
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.32
