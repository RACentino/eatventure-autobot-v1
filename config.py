...
UPGRADE_SEARCH_INTERVAL = 0.160
STATE_DELAY = 0.180
UPGRADE_STATION_VERIFY_SETTLE_DELAY = 0.260
UPGRADE_STATION_VERIFY_SEARCH_ATTEMPTS = 5
UPGRADE_STATION_VERIFY_SEARCH_INTERVAL = 0.155
CLICK_HOLD_MAX_DURATION = 7.2
...
ADAPTIVE_TUNER_MIN_CLICK_DELAY = 0.065
ADAPTIVE_TUNER_MAX_CLICK_DELAY = 0.145
ADAPTIVE_TUNER_MIN_MOVE_DELAY = 0.012
ADAPTIVE_TUNER_MAX_MOVE_DELAY = 0.040
ADAPTIVE_TUNER_MIN_SEARCH_INTERVAL = 0.135
ADAPTIVE_TUNER_MAX_SEARCH_INTERVAL = 0.300
...
AI_LEARNING_APPLY_COOLDOWN = 18.0
AI_LEARNING_MIN_CLICK_DELAY = 0.065
AI_LEARNING_MAX_CLICK_DELAY = 0.145
AI_LEARNING_MIN_MOVE_DELAY = 0.012
AI_LEARNING_MAX_MOVE_DELAY = 0.040
AI_LEARNING_MIN_SEARCH_INTERVAL = 0.135
AI_LEARNING_MAX_SEARCH_INTERVAL = 0.300
